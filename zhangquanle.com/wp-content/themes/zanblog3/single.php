...
<div id="zan-bodyer">
	<div class="container">
          ...
          <article class="zan-single-content">				                 
	        ...
	        <div class="zan-share clearfix">
		        <div class="bdsharebuttonbox pull-right">
					...
					<!-- 百度分享结束 -->
					<!-- 文章版权信息 -->
					<div class="copyright well" style="display:none;">
						...
						<p>
							...
							<?php
								if( get_post_meta( $post->ID, "版权属于:", true ) ) {
									...
									echo '<a href="http://zhangquanle.com" target="_blank">Gilbert-乐</a>';
								}
							?>
						</p>
						<p>
        ...
        <!-- 广告结束 -->
				<!-- 相关文章 -->
        <div class="visible-md visible-lg" id="post-related" style="diaplay:none;">
