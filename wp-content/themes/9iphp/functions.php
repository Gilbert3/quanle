...
function specs_theme_scripts() {
    ...
    if(!is_admin()){
        ...
        wp_enqueue_script( 'fancy', $dir . '/inc/fancy/jquery.fancybox.js', array(), '2.1.5');
        ...
        wp_enqueue_style( 'fancy-style', $dir . '/inc/fancy/jquery.fancybox.css', array(), '2.1.5');
...
/**
 * 9IPHP <Content images add the fancybox class> in the theme.
 *
 * 文章中图片增加fancybox属性
 * @version 1.0
 * @package Specs
