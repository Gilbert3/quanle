  ...
  if (($parent_id != '') && ($spam_confirmed != 'spam') && ($to != $admin_email) && ($comment_author_email == $admin_email)) {
    ...
    */
    ...
    $message = '<div style="background-color:#f8f8f8; border:1px solid #D2D1CB; color:#111; -moz-border-radius:8px; -webkit-border-radius:8px; -khtml-border-radius:8px; border-radius:8px; font-size:14px; width:702px; margin:0 auto; margin-top:10px;">
		<div style="background:#BA4C32; width:100%; height:60px; color:white; -moz-border-radius:6px 6px 0 0; -webkit-border-radius:6px 6px 0 0; -khtml-border-radius:6px 6px 0 0; border-radius:6px 6px 0 0; ">
			<span style="height:60px; line-height:60px; margin-left:30px; font-size:20px;"> 您在<a href="' . get_option('home') . '" style="text-decoration:none; color:#ff0;font-weight:600;" target="_blank">' . get_option('blogname') . '</a>上的评论有新回复啦！</span>
		</div>
		<div style="width:90%; margin:0 auto">
			...
			<p>您可以点击<a href="' . htmlspecialchars(get_comment_link($parent_id, array('type' => 'comment'))) . '" style="color:#BA4C32" target="_blank">查看完整内容</a></p><br />
			<p style="font-weight:600;">温馨提示：</p>
			<p>1.本邮件由系统自动发出，请勿直接回复，谢谢!</p>
			<p>2.找博客，就上<a href="http://boke123.net" style="color:#BA4C32" target="_blank">boke123导航</a>，请认准网址：<a href="http://boke123.net" style="color:#BA4C32" target="_blank">http://boke123.net</a>!</p>
			<p>3.<a href="http://boke123.net" style="color:#BA4C32" target="_blank">boke123导航</a>宗旨是让广大博客主能够体验到博客互访的方便与快捷服务!</p><br />
		</div>
		<div style="background:#BA4C32; width:100%; height:30px; color:white; -moz-border-radius:0 0 6px 6px; -webkit-border-radius:0 0 6px 6px;; -khtml-border-radius:0 0 6px 6px; border-radius:0 0 6px 6px; ">
			<span style="height:30px; line-height:30px; margin-left:30px; font-size:14px;">以后有空请多来访，<a href="' . get_option('home') . '" style="text-decoration:none; color:#ff0;font-weight:600;" target="_blank">' . get_option('blogname') . '</a>在此谢谢您的支持！</span>
		</div>
	</div>';
